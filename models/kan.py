...
class KANLinear(torch.nn.Module):
    ...
    def reset_parameters(self):
        """ 
            Both kaiming_uniform_ and xavier_uniform_ can use for text classification, but we are not sure how they
            affect the model performance. kaiming_uniform_ was initially designed for image classification. 
...
class KAN(torch.nn.Module):
    ...
    """
        From the original paper: The grid number G also has a subtle effect on interpretability. When G is too small, 
